...
as of now:
- workers: stateless, take env-steps. no policy copy, can scale to n workers, batched inference
...
- supports training in MJX & MuJoCo sims

planned additions:
- configurable timeout for inference batching
- configurable colocation or decoupling
- improved importance sampling correction
- better overall versioning and tagging hygiene (datasets, training runs, etc)
- structured data buffer over generic queue
- improved weight sync (broadcasting and shared memory)
- quantized inference
- QAT support
- on policy distillation
- evaluation in sim, and also generic evaluation methodologies
